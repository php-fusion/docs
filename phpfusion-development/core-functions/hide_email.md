...
$title \(string\) \(Optional\) The text of the link

$subject  \(string\) \(Optional\) A subject for a mail message if someone opens a link and it opens in the mail client
