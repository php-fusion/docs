...
PHP-Fusion uses a FUSION\_NULL constant to indicate there is a impending error that is going to happen soon to your system. This constant is used throughtout the entire system and fundamentally functions to complete the PHP-Fusion security feature ecosystem.
...
Declares FUSION\_NULL in the PHP-Fusion system. Some important components that is built to sense FUSION\_NULL are: dbquery\_insert\(\) and fusion\_safe\(\)
